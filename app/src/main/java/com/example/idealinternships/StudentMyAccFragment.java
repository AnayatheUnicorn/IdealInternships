...
public class StudentMyAccFragment extends Fragment {
    /**
     * Opens the my account student page after clicking on this page in the bottom navigation bar
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup conatiner, @Nullable Bundle savedInsatnceState){
        return inflater.inflate(R.layout.student_my_acc_fragment, conatiner,false);
    }
}
