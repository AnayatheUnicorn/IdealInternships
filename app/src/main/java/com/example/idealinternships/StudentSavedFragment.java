...
public class StudentSavedFragment extends Fragment {
    /**
     * Opens the student's saved internships page after clicking on this page in the bottom navigation bar
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup conatiner, @Nullable Bundle savedInsatnceState){
        return inflater.inflate(R.layout.student_saved_fragment, conatiner,false);
    }
}
