...
public class StudentHomeFragment extends Fragment {
    /**
     * Opens the student's home feed after clicking on this page in the bottom navigation bar
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup conatiner, @Nullable Bundle savedInsatnceState){
        return inflater.inflate(R.layout.student_home_fragment, conatiner,false);
    }
}
